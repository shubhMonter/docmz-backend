...
module.exports = {
  async getHomeById(req,res){
    try {
      ...
      return Home.findById(id).exec().then((home)=>{
        if(!home) return res.status(401).send({success:false,message:'No home found'})
      ...
      return Home
            ...
            .then(home => {
              ...
              return home.updateOne({
                ...
                appointment_text:req.body.appointment_text || home.appointment_text,
                howitworks_title_text:req.body.howitworks_title_text || home.howitworks_title_text,
                howitworks_header_text:req.body.howitworks_header_text || home.howitworks_header_text,
                howitworks_desc_text:req.body.howitworks_desc_text || home.howitworks_desc_text,
                howitworks_meta:req.body.howitworks_meta || home.howitworks_meta,
                specialities_text1:req.body.specialities_text1 || home.specialities_text1,
                specialities_text2:req.body.specialities_text1 || home.specialities_text2,
                specialities_meta:req.body.specialities_meta || home.specialities_meta,
              })
