...
module.exports = {
  async getContactById(req,res){
    try {
      ...
      return Contact.findById(id).exec().then((contact)=>{
        if(!contact) return res.status(401).send({success:false,message:'No contact found'})
      ...
      return Contact
            ...
            .then(contact => {
              ...
              return contact.updateOne({
                ...
                contact_address:req.body.contact_address || contact.contact_address,
                contact_email:req.body.contact_email || contact.contact_email,
                contact_phone:req.body.contact_phone || contact.contact_phone,
                contact_ask_header1:req.body.contact_ask_header1 || contact.contact_ask_header1,
                contact_ask_header2:req.body.contact_ask_header2 || contact.contact_ask_header2,
                contact_ask_desc:req.body.contact_ask_desc || contact.contact.contact_desc,
                contact_ask_button1:req.body.contact_ask_button1 || contact.contact_ask_button1,
                contact_ask_button2:req.body.contact_ask_button2 || contact.contact_ask_button1,
                contact_banner_img:req.body.contact_banner_img || contact.contact_banner_img,
                contact_touch_header1:req.body.contact_touch_header1 || contact.contact_touch_header1,
                contact_touch_header2:req.body.contact_touch_header2 || contact.contact_touch_header2,
                contact_touch_desc:req.body.contact_touch_desc || contact.contact_touch_desc,
              })
